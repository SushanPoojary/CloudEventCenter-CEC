 ...
 * @hidden
 */
function HeaderSelectionCell(props) {
    var defaultRendering = [
        (React.createElement("input", { key: 0, checked: props.selectionValue, id: props.inputId, type: "checkbox", className: "k-checkbox", onChange: function (e) {
